                    ...
                    <div className={style.password_form}>
                            ...
                            <div className={style.pwbox}>
                                <div className={style.box1}>
                                    <div className="relative w-full ">
                                        ...
                                        <div onClick={() => viewpassword1()} className="absolute right-2 top-2.5 h-4 w-4 text-muted-foreground">
                            ...
                            <div className={style.pwbox}>
                                <div className={style.box1}>
                                    <div className="relative w-full ">
                                        ...
                                        <div onClick={() => viewpassword2()} className="absolute right-2 top-2.5 h-4 w-4 text-muted-foreground">
                        ...
                        <div className={style.mt}>
                            ...
                            <div className={style.mt1}>
                                ...
                                <div className={style.text}>
                                    {t("Contain uppercase and lowercase")}
                                </div>
                            ...
                            <div className={style.pwbox}>
                                <div className={style.box1}>
                                    <div className="relative w-full ">
                                        ...
                                        <div onClick={() => viewpassword3()} className="absolute right-2 top-2.5 h-4 w-4 text-muted-foreground">
