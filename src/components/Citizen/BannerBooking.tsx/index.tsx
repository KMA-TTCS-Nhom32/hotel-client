...
const BannerBooking = ({ lng }: Readonly<BannerBooking>) => {
    ...
    return (
        <div className="flex mt-4 rounded-3xl" >
            <div className="bg-red-800 flex flex-col gap-5 shrink-0 justify-center w-2/5 ">
            ...
            <div className="w-3/5">
                <img className="w-full h-full" alt="" src="/images/banner-booking.png "/>
