    ...
    return (
        ...
        <div className='w-full pt-5 flex flex-col cursor-pointer sm:flex-row'>
            <div className='relative sm:w-1/3 h-full w-full'>
                ...
                <Image src={'/images/living-story-6-1.png'} alt='' height={100} width={276} className='h-full w-auto' ></Image>
            ...
            <div className='sm:flex sm:justify-between flex-row w-full'>
                <div className='flex flex-col py-2 px-3 gap-2 flex-col justify-between w-full sm:w-2/3' >
                    <p className='text-xs text-gray-500'>Thuộc đơn:
                        TNXCL121124OD27
                    </p>
                    ...
                    <div className=''>
                        ...
                        <div>
                            <p className=''>
                                <span className='uppercase text-sm text-orange-500'> Xcellent Thái Nguyên (test) </span>
                                <span> • </span>
                                <span className='text-xs'>38 tổ 1, Đồng Quang, Thành phố Thái Nguyên, Thái Nguyên</span>
                            </p>
                        </div>
                    </div>
                ...
                <div className='sm:w-3/12 w-full flex flex-col justify-between item-end  sm:border-dashed border-l-2 border-l-slate-400'>
                    ...
                    <div className="text-end">
                        <p className="body2 text-primary">Tổng tiền</p>
                        <p className="heading4-semi-bold x-hotel-main">-100.000đ</p>
                        <button className="xhotel-primary button hidden w-[124px] medium" type="button">Đặt lại</button>
                    </div>
