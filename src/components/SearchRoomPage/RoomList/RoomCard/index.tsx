...
const RoomCard = () => {
  ...
  return (
    <div className={styles.roomcard_containers}>
      <div
      ...
      >
        ...
        >
          ...
          <div className={`${styles.room_price} mt-4 md:w-1/3 border-t pt-4"`}>
            ...
            <button className='py-2 px-4 rounded transition'>Xem phòng</button>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          <div className={`${styles.room_detail} mb-4 md:w-2/3`}>
            ...
            <p className={`${styles.hotel_branch} text-sm font-medium mb-4`}>XCELLENT ĐÀ NẴNG</p>
            <div className='flex flex-wrap gap-3'>
              <Badge className='gap-2 w-auto py-2 rounded-full'>
                <Utensils className='h-4 w-4' />
                <span>Nhà hàng được Michelin đánh giá cực chất lượng</span>
          ...
          <div className={`${styles.room_price} mt-4 md:w-1/3 border-t pt-4"`}>
            <div className={`${styles.price_detail}`}>
              <span className={`${styles.price_range} text-lg font-semibold`}>CHỈ TỪ </span>
              <span className={`${styles.room_cost} text-green-600 text-2xl`}>800.000</span>
              <span className={`${styles.price_curency}`}>VND / Đêm</span>
              <p className={`${styles.price_tax} text-sm text-gray-500 mb-4`}>
                Đã bao gồm thuế và phí
              </p>
      ...
      >
        ...
        >
          <div className={`${styles.room_detail} mb-4 md:w-2/3`}>
            <h3 className={`${styles.roome_type} text-xl font-bold mb-2`}>Dulexe Room</h3>
            <p className={`${styles.hotel_branch} text-sm font-medium mb-4`}>XCELLENT HÀ NỘI</p>
            <div className='flex flex-wrap gap-3'>
              <Badge className='gap-2 w-auto py-2 rounded-full'>
                <Wifi className='h-4 w-4' />
                <span>Wifi Free thoải mái</span>
          ...
          <div className={`${styles.room_price} mt-4 md:w-1/3 border-t pt-4"`}>
            <div className={`${styles.price_detail}`}>
              <span className={`${styles.price_range} text-lg font-semibold`}>CHỈ TỪ </span>
              <span className={`${styles.room_cost} text-green-600 text-2xl`}>1.300.000</span>
              <span className={`${styles.price_curency}`}>VND / Đêm</span>
              <p className={`${styles.price_tax} text-sm text-gray-500 mb-4`}>
                Đã bao gồm thuế và phí
              </p>
